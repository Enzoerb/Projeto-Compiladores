...
public interface IsiLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#cmdrepeticaodowhile}.
	 * @param ctx the parse tree
	 */
	void enterCmdrepeticaodowhile(IsiLangParser.CmdrepeticaodowhileContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmdrepeticaodowhile}.
	 * @param ctx the parse tree
	 */
	void exitCmdrepeticaodowhile(IsiLangParser.CmdrepeticaodowhileContext ctx);
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#cmdrepeticaowhile}.
	 * @param ctx the parse tree
	 */
	void enterCmdrepeticaowhile(IsiLangParser.CmdrepeticaowhileContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmdrepeticaowhile}.
	 * @param ctx the parse tree
	 */
	void exitCmdrepeticaowhile(IsiLangParser.CmdrepeticaowhileContext ctx);
	/**
